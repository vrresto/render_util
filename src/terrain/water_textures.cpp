...
namespace render_util::terrain
{
    ...
    m_texture_manager(texture_manager)
  {
    ...
    params.loader.getDetailLayer().loadWaterMap(chunks, table);
    ...
    WaterMap map
    {
      .texunit_table = TEXUNIT_WATER_MAP_TABLE,
      .texunit = TEXUNIT_WATER_MAP,
    ...
    m_water_map = std::make_unique<WaterMap>(map);
  }
}
